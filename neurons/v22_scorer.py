"""v22 Deeper Hierarchical Action Transformer scorer (gen2)."""
...
MODEL_PATH = Path(__file__).resolve().parent / "model_v22_transformer.pkl"
...
class V22Scorer:
    def __init__(self):
        ...
        if not MODEL_PATH.exists():
            raise FileNotFoundError(f"v22 transformer not found at {MODEL_PATH}")
